...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.subtitle': 'We specialize in ITIN applications, tax services, and modern web development solutions.',
  ...
  es: {
    ...
    'hero.subtitle': 'Nos especializamos en aplicaciones ITIN, servicios de impuestos y soluciones modernas de desarrollo web.',
